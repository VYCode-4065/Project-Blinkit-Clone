...
const UploadProduct = () => {
  ...
  return (
    <section>
      <div className=" top-28 pt-2 lg:top-24">
        <div className="bg-neutral-50  shadow-sm shadow-pink-400 p-2 rounded flex items-center justify-between  ">
          <h2 className="font-semibold text-md">Upload Product</h2>
        </div>
        <div className="grid gap-3">
          <form action="" className="grid gap-4 p-4" onSubmit={handleOnSubmit}>
              ...
              <select
                onChange={(e) => {
                  ...
                  setProductData((prev) => {
                    return {
                      ...prev,
                      category_id: [...prev.category_id, categoryDetail],
                    };
                  });
                  e.target.value = "";
                }}
              ...
              <select
                onChange={(e) => {
                  ...
                  setProductData((prev) => {
                    return {
                      ...prev,
                      subCategory: [...prev.subCategory, SubcategoryDetail],
                    };
                  });
            ...
            {Object?.keys(productData?.more_details)?.map((keyValue, index) => {
              return (
